...
export default function CompetitionDetail() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      loadDivisions(),
      fetch(`https://api.events.worldstrongman.org/competitions/events-divisions/${competitionId}`)
        .then(r => r.json())
 ...
 <Layout> 
  ...
  <div style={{ display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <a href={`https://api.events.worldstrongman.org/competitions/${competitionId}/draw`} target="_blank" style={{ padding: '8px 16px', background: 'transparent', border: `1px solid ${gold}`, color: gold, borderRadius: '3px', fontSize: '11px', fontWeight: '700', textDecoration: 'none' }}>🎲 DRAW</a>
            <a href={`https://api.events.worldstrongman.org/competitions/${competitionId}/live-screen`} target="_blank" style={{ padding: '8px 16px', background: 'transparent', border: '1px solid #555', color: '#888', borderRadius: '3px', fontSize: '11px', fontWeight: '700', textDecoration: 'none' }}>📺 LIVE</a>
            <a href={`https://api.events.worldstrongman.org/competitions/${competitionId}/warmup-screen`} target="_blank" style={{ padding: '8px 16px', background: 'transparent', border: '1px solid #555', color: '#888', borderRadius: '3px', fontSize: '11px', fontWeight: '700', textDecoration: 'none' }}>🏋️ WARMUP</a>
            <a href={`https://api.events.worldstrongman.org/competitions/${competitionId}/protocol`} target="_blank" style={{ padding: '8px 16px', background: 'transparent', border: `1px solid ${gold}`, color: gold, borderRadius: '3px', fontSize: '11px', fontWeight: '700', textDecoration: 'none' }}>🖨️ PROTOCOL</a>
            <a href={`https://api.events.worldstrongman.org/competitions/${competitionId}/certificates`} target="_blank" style={{ padding: '8px 16px', background: gold, color: '#000', border: 'none', borderRadius: '3px', fontSize: '11px', fontWeight: '700', textDecoration: 'none' }}>📜 CERTIFICATES</a>
            ...
            <a href="https://api.events.worldstrongman.org/organizer/help" target="_blank" style={{ padding: '8px 16px', background: 'transparent', border: '1px solid #333', color: '#555', borderRadius: '3px', fontSize: '11px', fontWeight: '700', letterSpacing: '1px', textDecoration: 'none' }}>📖 HELP</a>
          </div>
        </div>
      </div>
  ...
  {tab === 'Start Order' && (
        ...
        <div>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              <a href={`https://api.events.worldstrongman.org/competitions/${competitionId}/protocol`} target="_blank" style={{ padding: '8px 18px', background: 'transparent', border: `1px solid ${gold}`, color: gold, borderRadius: '3px', fontSize: '11px', fontWeight: '700', textDecoration: 'none' }}>🖨️ PRINT</a>
      ...
      <div className="wsm-banner-wrap" style={{ marginTop: '32px', background: '#111', border: '1px solid #1e1e1e', borderRadius: '4px', padding: '20px', marginBottom: '20px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
        {competition.banner_url
          ? <img src={competition.banner_url?.startsWith('http') ? competition.banner_url : `https://api.events.worldstrongman.org${competition.banner_url}`} style={{ width: '100%', maxWidth: '300px', height: '120px', objectFit: 'cover', borderRadius: '4px', border: '1px solid #2a2a2a' }} />
        ...
        {sponsors.map(s => (
          <div key={s.id} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '8px 0', borderBottom: '1px solid #1a1a1a' }}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
              {s.logo_url ? <img src={s.logo_url?.startsWith("http") ? s.logo_url : `https://api.events.worldstrongman.org${s.logo_url}`} style={{ width: '80px', height: '50px', objectFit: 'contain', background: '#1a1a1a', borderRadius: '4px' }} /> : <div style={{ width: '80px', height: '50px', background: '#1a1a1a', border: '1px dashed #333', borderRadius: '4px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#444' }}>🎽</div>}
